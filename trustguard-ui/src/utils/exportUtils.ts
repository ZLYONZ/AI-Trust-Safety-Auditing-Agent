...
const generatePDFHTML = (reportData: AuditReportData): string => {
    ...
    <head>
      <meta charset="UTF-8">
      <title>TrustGuard Nexus - Audit Report</title>
      <style>
        @media print {
          @page {
            margin: 1in;
    ...
    <body>
      <!-- Header -->
      <div class="header">
        <div class="logo">TrustGuard Nexus</div>
      ...
      <!-- Footer -->
      <div class="footer">
        <p>This report was generated by TrustGuard Nexus AI Trust & Safety Auditing Platform</p>
