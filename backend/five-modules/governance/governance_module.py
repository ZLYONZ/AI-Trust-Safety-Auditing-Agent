...
from governance_scoring import calculate_module_score, determine_severity, determine_risk_level
...
class GovernanceModule:
    ...
    def run(self, document_text):
        ...
        data = call_llm_json(
            client, MODEL,
            system_prompt="You are an AI governance and compliance auditor. Return ONLY JSON.",
            user_prompt=prompt,
        )
