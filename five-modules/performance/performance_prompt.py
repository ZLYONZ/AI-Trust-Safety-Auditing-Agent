def build_prompt(document_text, criteria):
    ...
    prompt = f"""
You are an AI performance and model monitoring auditor.

Evaluate the organization's AI systems for model performance monitoring
and drift management based on the following criteria:
...
For EACH performance monitoring criterion determine:
